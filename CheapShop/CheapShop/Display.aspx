<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.Master" AutoEventWireup="true" CodeBehind="Display.aspx.cs" Inherits="CheapShop.Display" %>
      ...
      <form id="form1" runat="server">
        <div>
            ...
            <asp:DataList ID="DataList1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="5px" CellPadding="3" CellSpacing="2" DataKeyField="Id" DataSourceID="SqlDataSource1" GridLines="Both" RepeatColumns="5" OnItemCommand="DataList1_ItemCommand">
                ...
                <ItemTemplate>
                    <table class="auto-style1">
                        <tr>
                            <td class="text-center">Product ID:<asp:Label ID="Label2" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">Product Name:<asp:Label ID="Label3" runat="server" Text='<%# Eval("product_name") %>'></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-left">
                        ...
                        <tr>
                            <td class="text-center">Category:<asp:Label ID="Label4" runat="server" Text='<%# Eval("poduct_cat") %>'></asp:Label>
                            </td>
                        </tr>
                         <tr>
                        ...
                        <tr>
                            <td class="text-center">TK:<asp:Label ID="Label6" runat="server" Text='<%# Eval("product_price") %>'></asp:Label>
                            </td>
                        </tr>
                        <tr>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MaintabConnectionString %>" SelectCommand="SELECT * FROM [Product] WHERE ([poduct_cat] = @poduct_cat)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="display" Name="poduct_cat" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
