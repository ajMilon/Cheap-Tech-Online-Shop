<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.Master" AutoEventWireup="true" CodeBehind="Ic.aspx.cs" Inherits="CheapShop.Ic" %>
      ...
      <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MaintabConnectionString %>" SelectCommand="SELECT * FROM [Product] WHERE ([poduct_cat] = @poduct_cat)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="ic" Name="poduct_cat" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
