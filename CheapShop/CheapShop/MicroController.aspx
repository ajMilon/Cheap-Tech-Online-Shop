<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.Master" AutoEventWireup="true" CodeBehind="MicroController.aspx.cs" Inherits="CheapShop.MicroController" %>
      ...
      <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MaintabConnectionString %>" SelectCommand="SELECT * FROM [Product] WHERE ([poduct_cat] = @poduct_cat)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="microcontroller" Name="poduct_cat" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
